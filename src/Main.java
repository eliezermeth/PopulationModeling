...
public class Main
{
    public final double FERTILITY_RATE = 1; // chance of childbirth, 0-1
    public final double MALE_CHANCE = 0.5; // chance of male birth out of 1
    public final int BEGIN_CHILDBIRTH_YEARS = 20;
    public final int END_CHILDBIRTH_YEARS = 40; // no longer able to give birth
    ...
    public ArrayList<double[]> popPool = new ArrayList();
    ...
    public Main()
    {
        ...
        double[] temp = popPool.get(19); // age 19; becomes 20 at year cycle
        temp[0] = 25;
        temp[1] = 25;
    ...
    public void yearCycle()
    {
        ...
        popPool.add(0, new double[]{0, 0, 0, 0});
        ...
        double[] newChildren = calculateChildbirth();
     ...
     */
    public double[] calculateChildbirth()
    {
        double[] newChildren = {0, 0};
        ...
        {
            double[] temp = calculateChildbirthUtil(i);
     ...
     */
    public double[] calculateChildbirthUtil(int age)
    {
        ...
        double[] newChildren = {0, 0};
        for (double i = 0; i < popPool.get(age)[3]; i++) // for each married female
        {
        ...
        for (int age = end; age > BEGIN_CHILDBIRTH_YEARS - 1; age--)
        {
            ...
            if (currentAgePool[0] != 0) // males remaining
            {
                        ...
                        && currentAgePool[0] != 0; i++) // and single males remaining
                {
                    ...
                    {
                        double num = Math.min(currentAgePool[0], popPool.get(age - i)[1]);
            ...
            if (currentAgePool[1] != 0) // females remaining
            {
                        ...
                        && currentAgePool[1] != 0; i++) // and single females remaining
                {
                    ...
                    {
                        double num = Math.min(currentAgePool[1], popPool.get(age - i)[0]);
    ...
    public double getPopulationOfAge(int age)
    {
        double sum = 0;
        double[] array = popPool.get(age);
    ...
    {
        for (int i = 0; i < popPool.size(); i++)
            System.out.println(String.format("%3d", i) + " : " + Arrays.toString(popPool.get(i)));
    }
